...
<p>L'agent qualifie les demandes de devis et cale les visites dans votre tournée. Il transforme votre dictée en devis à votre en-tête, relance les devis sans réponse et prépare la commande de matériel dès la signature. Il suit aussi les chantiers longs, les factures et la prospection auprès des syndics.</p>
...
Vous lui parlez comme à un employé, par message ou à la voix depuis la camionnette. Inutile de tout lui confier d'un coup. Un agent qui tient **très bien les demandes et les devis** vous rendra plus de services qu'un agent qui bâcle toute la chaîne.
...
<figure>
<div class="message">
<div class="expediteur"><span>Assistant de l'entreprise</span><span>jeudi 10:32</span></div>
<div class="ligne"><strong>Nouvelle demande : borne de recharge à Illkirch</strong></div>
<div class="ligne">Mme Keller, maison de 1998, tableau dans le garage (photo jointe). Compteur à 12 m de la place de stationnement.</div>
<div class="ligne">Elle est disponible mardi matin ou jeudi après 17 h.</div>
<div class="ligne">Jeudi vous finissez à Ostwald vers 16 h 30, à 10 minutes de chez elle. Je lui propose jeudi 17 h ?</div>
<div class="actions"><span>Proposer jeudi 17 h</span><span>Autre créneau</span><span>Je l'appelle</span></div>
</div>
<figcaption>Exemple de demande qualifiée reçue pendant un chantier. Le nom, les lieux et les chiffres sont fictifs.</figcaption>
</figure>

### Des visites calées dans la tournée
...
Vous décidez aussi de ce qui ne peut pas attendre. Une panne générale chez un client sous contrat vous est remontée tout de suite par un appel alors qu'une demande de prises supplémentaires attend le récap du soir.
...
<figure>
<div class="message">
<div class="expediteur"><span>Assistant de l'entreprise</span><span>jeudi 17:48</span></div>
<div class="ligne"><strong>Devis prêt à relire : Mme Keller, borne 7 kW</strong></div>
<div class="ligne">9 lignes reprises de votre dictée. Total 1 640 € HT.</div>
<div class="ligne">Une ligne sans prix dans votre grille : le câble 3G10. J'ai mis le dernier prix de votre grossiste et je l'ai surligné.</div>
<div class="ligne">Validité 30 jours et acompte de 30 % à la commande, comme sur vos autres devis.</div>
<div class="actions"><span>Relire et envoyer</span><span>Corriger une ligne</span></div>
</div>
<figcaption>Exemple de devis préparé à partir d'une dictée. Les montants et la puissance sont fictifs.</figcaption>
</figure>

### Les mentions qui ne s'oublient plus

L'électricité fait partie des activités où le devis est obligatoire avant les travaux et [Entreprendre Service-Public](https://entreprendre.service-public.gouv.fr/vosdroits/F31144) liste ce qu'il doit contenir. Le décompte détaillé en quantité et en prix y côtoie le taux horaire TTC, les frais de déplacement et la durée de validité de l'offre. Ces mentions se règlent une fois dans le modèle et l'agent n'a plus à y penser.
...
L'agent tire du devis signé une commande pour votre grossiste avec les références et les quantités puis il retire ce que vous avez déjà en stock si vous tenez une liste du dépôt. La commande attend votre feu vert et la date de livraison part ensuite dans l'agenda du chantier. Si le disjoncteur que vous aviez prévu est en rupture, vous l'apprenez le jour de la commande et non le matin de la pose.

### Les chantiers longs et leurs papiers

Une rénovation complète dure des semaines et dépend des autres corps de métier. L'agent tient le planning partagé et demande chaque vendredi au plaquiste ou au plombier si leur date tient toujours. Quand le placo glisse d'une semaine, il vous propose de déplacer votre seconde intervention et prévient le client.
...
À la fin du chantier l'agent rassemble ce que le client doit recevoir : les notices et les photos du tableau repéré, les garanties du matériel et la facture. Pour une installation neuve ou entièrement rénovée il prépare aussi le dossier de l'attestation de conformité mais il ne la remplit pas et ne la signe pas.

<figure>
<ol class="flux">
<li><strong>Demande</strong>qualifiée avec photos</li>
<li><strong>Visite</strong>calée dans la tournée</li>
<li><strong>Devis</strong>dicté, relu puis relancé</li>
<li><strong>Chantier</strong>matériel commandé, planning tenu</li>
<li><strong>Facture</strong>envoyée, puis avis demandé</li>
</ol>
<figcaption>Le parcours d'un chantier, du premier message à l'avis Google.</figcaption>
</figure>

### La facture et l'avis après le chantier

Le chantier terminé, vous dites « chantier Keller fini, rien à ajouter » et la facture part d'après le devis signé. Depuis le 1er septembre 2026 toute entreprise doit pouvoir recevoir des factures électroniques et les petites entreprises devront en émettre [à partir du 1er septembre 2027](https://entreprendre.service-public.gouv.fr/vosdroits/F23208). Un agent n'est pas une plateforme agréée : il prépare la facture et c'est votre logiciel ou votre plateforme qui l'émet.

Quelques jours plus tard l'agent remercie le client et lui envoie le lien pour laisser un avis. Il le fait pour tous les clients sans exception parce que Google interdit de [solliciter des avis uniquement auprès des clients satisfaits](https://support.google.com/contributionpolicy/answer/7400114?hl=fr).

En fin de mois il range les factures d'achat du grossiste, les tickets de carburant et les factures émises dans le dossier du comptable. Chaque soir à 19 h un seul message résume la journée.

<figure>
<div class="message">
<div class="expediteur"><span>Assistant de l'entreprise</span><span>jeudi 19:00</span></div>
<div class="ligne"><strong>Votre jeudi en quatre lignes</strong></div>
<div class="ligne">2 devis signés aujourd'hui pour 4 310 € HT. La commande de matériel du chantier Roth attend votre feu vert.</div>
<div class="ligne">3 factures parties. L'acompte de la rénovation rue des Vosges est arrivé ce matin.</div>
<div class="ligne">6 devis sans réponse depuis plus d'une semaine : 4 relancés aujourd'hui et 2 à leur seconde relance lundi.</div>
<div class="ligne">Demain : 3 interventions, départ 7 h 30. Le plaquiste confirme sa date, votre passage de mardi tient.</div>
<div class="actions"><span>Valider la commande</span><span>Voir demain</span></div>
</div>
...
Le dépannage fait tourner la semaine mais les chantiers qui font l'année se cherchent ailleurs et la mise en sécurité des logements anciens est souvent oubliée. Un propriétaire qui vend ou qui loue un logement doit fournir un diagnostic électricité dès que [l'installation a plus de quinze ans](https://www.service-public.gouv.fr/particuliers/vosdroits/F18692). Ce diagnostic liste des anomalies que l'acheteur voudra voir corrigées et quelqu'un devra bien faire les travaux. Les agences immobilières, les syndics et les diagnostiqueurs de votre secteur voient passer ces dossiers chaque semaine.

### Les syndics et les agences par mail

L'agent dresse la liste des syndics, des agences et des gestionnaires de biens dans votre rayon d'action à partir de sources publiques. Il prépare pour chacun un mail court qui dit ce que vous faites, dans quel délai vous intervenez et comment vous joindre. Vous relisez le premier envoi et l'agent suit les réponses, relance une fois et note qui veut être rappelé au printemps. Ce démarchage entre professionnels a ses règles et j'y reviens plus bas.
...
Une IA généraliste parle de sections de câble et de calibres avec beaucoup d'aplomb et elle peut réciter une version périmée de la norme NF C 15-100 sans le savoir. Le [ministère de la Transition écologique](https://www.ecologie.gouv.fr/politiques-publiques/securite-installations-electriques-gaz) rappelle que l'attestation de conformité d'une installation neuve ou entièrement rénovée est établie et signée par l'auteur des travaux avant d'être visée par un organisme agréé. Cette signature est la vôtre. L'agent recopie ce que vous dictez et ne propose jamais un calibre ni une section de lui-même.
...
L'agent peut répondre aux demandes de bornes et préparer les devis mais il ne peut pas vous donner le droit de les poser. Le [programme Advenir](https://advenir.mobi/qualification-irve/) rappelle que tout installateur de bornes doit détenir une qualification IRVE depuis le décret du 12 janvier 2017 et que seuls Qualifelec, l'AFNOR et Qualit'EnR la délivrent. Sans elle, l'agent oriente la demande vers un confrère qualifié ou vous la signale.

### Démarcher des particuliers au téléphone
