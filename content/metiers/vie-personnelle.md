...
La différence avec une conversation sur ChatGPT tient en une phrase : ChatGPT attend votre question alors que l'agent travaille pendant que vous faites autre chose. Il est branché sur votre boîte mail et votre agenda et il sait quel jour tombe le renouvellement de votre assurance.

<div class="encadre">
<p><strong>En bref</strong></p>
<p>L'agent résume votre boîte mail et vous envoie chaque matin le point de la journée. Il surveille vos abonnements, compare votre assurance, votre énergie et votre forfait à partir de vos vrais contrats puis prépare les lettres de résiliation et de réclamation. Il range vos papiers, retrouve une facture sur simple question et vous prévient avant chaque échéance du foyer.</p>
...
<figure>
<div class="message">
<div class="expediteur"><span>Votre assistant</span><span>lundi 7:30</span></div>
<div class="ligne"><strong>Bonjour. Voici votre lundi.</strong></div>
<div class="ligne">Agenda : réunion à l'école à 18 h. Pluie annoncée jusqu'à midi.</div>
<div class="ligne">Mails : 47 reçus ce week-end et 3 demandent une réponse. Le reste est résumé plus bas et marqué comme lu.</div>
<div class="ligne">Votre assurance auto annonce 640 € pour l'an prochain, soit 58 € de plus. La comparaison est prête.</div>
<div class="ligne">Échéances : contrôle technique avant le 14 novembre et passeport à refaire avant les vacances de février.</div>
<div class="actions"><span>Voir les 3 mails</span><span>Ouvrir la comparaison</span><span>Réserver le contrôle technique</span></div>
</div>
...
### La chaîne complète d'un contrat d'assurance

Prenons le mail qui annonce l'échéance de votre assurance auto. L'agent le repère et le rapproche du contrat rangé dans vos dossiers, si bien qu'il connaît vos garanties, votre franchise et le prix de l'an dernier. Il prépare ensuite la comparaison à garanties égales avec l'écart en euros sur l'année.

Si vous décidez de changer, la loi vous facilite la tâche parce qu'un contrat d'assurance auto se résilie [à tout moment après la première année](https://www.service-public.gouv.fr/particuliers/vosdroits/F2659) et que le nouvel assureur envoie lui-même la demande à l'ancien. L'agent rassemble les pièces que le nouvel assureur demandera puis note la nouvelle échéance et l'année suivante la même chaîne repart toute seule.

<figure>
<ol class="flux">
<li><strong>Le mail arrive</strong>avis d'échéance ou hausse de tarif</li>
<li><strong>Rapprochement</strong>contrat, garanties et prix actuel</li>
<li><strong>Comparaison</strong>à garanties égales, écart en euros</li>
<li><strong>Votre décision</strong>rester, négocier ou changer</li>
<li><strong>Suite</strong>courrier prêt, nouvelle échéance notée</li>
</ol>
<figcaption>Le parcours d'un contrat. L'agent déroule les étapes et la décision reste chez vous.</figcaption>
</figure>

Pour l'électricité et le gaz, l'agent lit votre consommation réelle sur vos factures et la reporte dans le [comparateur officiel du médiateur national de l'énergie](https://comparateur-offres.energie-info.fr/). Le forfait mobile se compare de la même façon.

Les abonnements qui peuvent se souscrire en ligne doivent aussi pouvoir se résilier en ligne depuis juin 2023 grâce à la [résiliation « en trois clics »](https://www.service-public.gouv.fr/particuliers/actualites/A16599). L'agent vous conduit jusqu'au bon bouton et le dernier clic reste le vôtre.

### Les lettres qu'on repousse

Contester une facture, demander un remboursement ou réclamer une indemnité sont des courriers que tout le monde sait écrire et que personne n'écrit. [Service-Public](https://www.service-public.gouv.fr/particuliers/vosdroits/F10977) indique par exemple qu'un vol arrivé avec trois heures de retard ou plus peut ouvrir droit à une indemnité forfaitaire de 250 à 600 € selon la distance, sauf circonstances exceptionnelles comme une météo violente.
...
Chaque facture, chaque fiche de paie et chaque avis d'imposition reçus par mail sont rangés dans votre espace de stockage selon un plan fixé une fois pour toutes. Le papier arrivé par la poste se photographie avec le téléphone et suit le même chemin.

L'agent connaît les durées de conservation publiées par [Service-Public](https://www.service-public.gouv.fr/particuliers/vosdroits/F19134) : les bulletins de salaire se gardent jusqu'à la liquidation de la retraite, les factures d'électricité cinq ans et la facture d'un appareil jusqu'à la fin de sa garantie.

Le jour où vous cherchez un document, vous posez la question comme à quelqu'un de la maison.

<figure>
<div class="message">
<div class="expediteur"><span>Votre assistant</span><span>samedi 10:13</span></div>
<div class="ligne">Vous : « Retrouve la facture du lave-linge. Il est encore sous garantie ? »</div>
<div class="ligne"><strong>Oui, jusqu'au 3 mars 2027.</strong></div>
<div class="ligne">Facture du 3 mars 2025, 489 €, rangée dans Maison puis Électroménager. La garantie légale de conformité court deux ans à partir de la livraison.</div>
<div class="ligne">Je prépare le message au vendeur avec la facture et la description de la panne ?</div>
<div class="actions"><span>Préparer le message</span><span>Voir la facture</span></div>
</div>
<figcaption>Exemple de question posée à l'agent. La date et le montant sont fictifs.</figcaption>
</figure>

La règle vient de la [garantie légale de conformité](https://www.service-public.gouv.fr/particuliers/vosdroits/F11094) qui donne deux ans à l'acheteur d'un bien neuf.

### Les échéances du foyer
...
Vous dites « trouve-moi un ophtalmo avant Noël » et l'agent cherche les créneaux affichés en ligne qui tiennent dans votre agenda. Beaucoup de plateformes de rendez-vous n'ouvrent pas leur porte aux outils extérieurs et je ne promets donc pas qu'il réservera partout sans vous. Dans ce cas il vous envoie le lien du créneau repéré et vous confirmez en dix secondes.

### La semaine de la famille

Une famille jongle avec le foot du mercredi et le solfège du samedi, avec l'anniversaire d'un camarade de classe et le cadeau à trouver avant. L'agent lit les mails de l'école et des clubs puis pose chaque date dans l'agenda partagé. Il vous rappelle un anniversaire dix jours avant avec deux idées de cadeau et il tient le tableau des tours de covoiturage pour que ce ne soit pas toujours la même voiture.

Le dimanche soir il propose les menus de la semaine et la liste de courses arrive déjà rangée par rayon.

<figure>
<div class="message">
<div class="expediteur"><span>Votre assistant</span><span>dimanche 18:30</span></div>
<div class="ligne"><strong>La semaine de la famille</strong></div>
<div class="ligne">Mercredi : foot à 14 h et c'est votre tour de covoiturage. Samedi : anniversaire à 15 h, cadeau à prévoir.</div>
<div class="ligne">L'école demande l'autorisation de sortie avant jeudi. Je l'ai remplie et il ne manque que votre signature.</div>
<div class="ligne">Menus proposés pour cinq soirs et liste de courses de 23 articles, environ 85 €.</div>
<div class="actions"><span>Voir les menus</span><span>Idées de cadeau</span><span>Ouvrir l'autorisation</span></div>
</div>
<figcaption>Exemple de message du dimanche soir. Les horaires et les montants sont fictifs.</figcaption>
</figure>

### Un week-end ou un voyage
...
### Jouer au courtier ou au conseiller en placements

Comparer deux contrats à garanties égales revient à poser des chiffres côte à côte. Recommander un placement est un autre métier et il est réglementé : l'AMF rappelle qu'un conseiller en investissements financiers doit être [immatriculé au registre de l'Orias](https://protectepargne.amf-france.org/comment-s-assurer-du-serieux-d-un-conseiller-financier). L'agent ne vous dira donc jamais où placer votre épargne et il ne choisit pas non plus votre assurance à votre place.
