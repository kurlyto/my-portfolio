...
La question qui arrive juste après est toujours la même et elle est légitime : que deviennent les données couvertes par le secret professionnel ? Cette page y consacre un chapitre entier parce que la réponse dépend moins de l'agent que du modèle d'IA qui tourne derrière et de l'endroit où il tourne.

<div class="encadre">
<p><strong>En bref</strong></p>
<p>Un agent IA prend en charge le tri des mails, le suivi des délais, les résumés de pièces et les relances d'honoraires. L'avocat valide tout ce qui sort du cabinet.</p>
...
Prenons un lundi matin. La boîte du cabinet a reçu une quarantaine de mails pendant le week-end et les trois qui comptent vraiment sont noyés entre les newsletters et les notifications. Un confrère a transmis un paquet de pièces sur un dossier en cours, un client demande où en est son affaire et deux factures d'honoraires attendent leur règlement depuis plus d'un mois. Il faut encore vérifier qu'aucun délai de procédure ne tombe cette semaine.
...
Imaginez un assistant qui arriverait au cabinet avant tout le monde et aurait lu chaque mail avant votre premier café. Il ne plaide pas et ne signe rien, mais il prépare le terrain pour que votre première heure serve à décider plutôt qu'à trier.
...
- **Les premiers brouillons.** À partir de vos trames habituelles il prépare un projet de courrier ou de conclusions que vous reprenez à votre main.
...
<div class="ligne">3 mails urgents sur 41 reçus ce week-end.</div>
<div class="ligne">Dossier 23-089 : conclusions à signifier avant vendredi.</div>
<div class="ligne">Dossier 24-112 : audience jeudi à 14 h. Les pièces adverses sont arrivées hier et leur résumé est prêt.</div>
<div class="ligne">2 factures impayées depuis plus de 45 jours. Les relances attendent votre accord.</div>
<div class="actions"><span>Voir les urgences</span><span>Valider les relances</span></div>
</div>
<figcaption>Exemple de point du matin. Les dossiers sont désignés par leur numéro et les chiffres sont fictifs.</figcaption>
</figure>

Le message ne cite aucun nom de client. Travailler par numéro de dossier est une habitude toute simple qui réduit ce qui circule et elle prend tout son sens dans le chapitre qui suit.
...
### Ce que disent la loi et le CNB

L'[article 66-5 de la loi du 31 décembre 1971](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000023780802) place sous le secret les consultations, les correspondances avec le client et plus largement toutes les pièces du dossier. Sa violation relève de l'[article 226-13 du code pénal](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006417945) et peut coûter un an de prison et 15 000 € d'amende.
...
Les lignes qui suivent ne remplacent pas la lecture de ce guide. Elles aident à comprendre ce que recouvrent ces vérifications et pourquoi certains montages résistent mieux que d'autres.
