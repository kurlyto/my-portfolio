...
export const PROVIDER_COLUMNS = [
  ...
  { key: "models", label: "Modèles principaux" },
  { key: "location", label: "Serveurs / résidence UE" },
  { key: "jurisdiction", label: "Droit applicable" },
  { key: "training", label: "Entraînement sur vos données" },
  { key: "retention", label: "Rétention" },
  { key: "health", label: "Données de santé FR" },
  { key: "openWeights", label: "Poids ouverts" },
  { key: "price", label: "Prix (entrée / sortie)" },
];
...
export const PROVIDERS = [
  {
    ...
    jurisdiction: { label: "France, hors Cloud Act", tone: "good" },
    training: "Non sur offre payante, à confirmer contractuellement",
    retention: "Non vérifié",
    health: { label: "Auto-hébergé sur HDS", tone: "warn" },
  ...
  },
  {
    ...
    retention: "Non vérifié",
    health: { label: "Hors périmètre HDS", tone: "bad" },
  ...
  },
  {
    ...
    health: { label: "ISO 27001 seul, pas HDS", tone: "bad" },
    openWeights: "Modèles ouverts",
  ...
  },
  {
    ...
    jurisdiction: { label: "France, SecNumCloud", tone: "good" },
    training: "Non vérifié",
    retention: "Non vérifié",
    health: { label: "HDS sur PaaS, IA non vérifiée", tone: "warn" },
  ...
  },
  {
    ...
    jurisdiction: { label: "US, Cloud Act malgré l'hébergement FR", tone: "bad" },
    training: "Non",
    retention: "Configurable, ZDR sur dossier",
    health: { label: "Infra HDS, périmètre IA non vérifié", tone: "warn" },
    openWeights: "Non",
  ...
  },
  {
    ...
    jurisdiction: { label: "Exécution locale, pas de transfert", tone: "good" },
    training: "Sans objet",
    retention: "Aucune si auto-hébergé",
    health: { label: "Oui si déployé sur HDS", tone: "good" },
  ...
  },
  {
    ...
    jurisdiction: { label: "Chine en API, à proscrire", tone: "bad" },
    training: "Via API : à considérer comme oui",
    retention: "Sans objet si auto-hébergé",
    health: { label: "Auto-hébergé sur HDS seulement", tone: "warn" },
  ...
  },
  {
    ...
    location: "Chine",
    jurisdiction: { label: "Chine, à proscrire en API", tone: "bad" },
    training: "À considérer comme oui",
    retention: "Non vérifié",
    health: { label: "Non en API", tone: "bad" },
  ...
  },
  {
    ...
    jurisdiction: { label: "US / Canada, Cloud Act", tone: "bad" },
    training: "Non sur offre entreprise, non vérifié",
    retention: "Non vérifié",
    health: { label: "Non en SaaS", tone: "bad" },
