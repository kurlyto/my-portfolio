...
export const RAG_TOOL_COLUMNS = [
  ...
  { key: "multiUser", label: "Multi-utilisateurs et droits" },
  { key: "formats", label: "Formats lus" },
  { key: "ocr", label: "OCR des PDF scannés" },
  { key: "sources", label: "Citation des sources" },
  { key: "offline", label: "Hors ligne avec Ollama" },
  { key: "ceiling", label: "Plafond mesuré" },
];
...
export const RAG_TOOLS = [
  {
    ...
    ocr: { label: "Natif depuis v1.7.4", tone: "good" },
  ...
  },
  {
    ...
    domain: "onyx.app",
    license: { label: "MIT (Community)", tone: "good" },
    ...
    sources: "Oui",
    offline: { label: "Oui, air-gapped supporté", tone: "good" },
