...
const ROWS = [
  {
    ...
    agent: "Il connaît vos clients, vos règles et vos habitudes. Vous expliquez une fois et il s'en souvient pour de bon",
  },
  {
  ...
  {
    generic: "Il vous donne du texte et vous laisse faire le reste",
    agent: "Il envoie, relance, classe et remplit vos outils à votre place",
  },
  {
    generic: "Il ne connaît ni vos mails ni vos factures ni votre agenda",
    ...
    <section className="bg-white border-t border-black/10">
      <Reveal className="max-w-5xl mx-auto px-6 py-16 md:py-36">
        ...
        <p className="mt-6 text-base md:text-lg opacity-70 leading-relaxed max-w-2xl">
          ChatGPT ou Gemini répondent à vos questions. Un agent fait le travail à votre place.
        </p>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="rounded border-2 border-accent/40 bg-[#faf8f5] p-6 md:p-8 shadow-[0_20px_50px_-20px_rgba(255,107,53,0.25)]">
            <p className="kicker text-[12px] font-mono uppercase tracking-widest">
              Votre agent
            </p>
            <ul className="mt-6 flex flex-col gap-5">
              {ROWS.map((row) => (
